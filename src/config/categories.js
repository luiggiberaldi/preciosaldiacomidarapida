import {
    Utensils, Sandwich, Flame, Pizza, Coffee, Package, LayoutGrid
} from 'lucide-react';
...
export const CATEGORY_COLORS = {
    fast_red: 'bg-red-500 text-white border-transparent shadow-sm dark:bg-red-600', // Ketchup
    fast_yellow: 'bg-yellow-400 text-yellow-900 border-yellow-500 shadow-sm font-black dark:bg-yellow-500', // Queso
    fast_orange: 'bg-orange-500 text-white border-transparent shadow-sm dark:bg-orange-600', // Fuego
    fast_amber: 'bg-amber-400 text-amber-900 border-amber-500 shadow-sm font-black dark:bg-amber-600', // Fritura
    fast_blue: 'bg-blue-500 text-white border-transparent shadow-sm dark:bg-blue-600', // Frio/Hielo
    fast_green: 'bg-emerald-500 text-white border-transparent shadow-sm dark:bg-emerald-600', // Salsas/Verduras
