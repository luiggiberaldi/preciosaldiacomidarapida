...
export default async function runOneSignal() {
  try {
      ...
      notifyButton: {
        ...
        text: {
          ...
          "message.action.subscribed":
            "¡Listo! Te avisaremos cuando cambie el BCV.",
          ...
          "dialog.blocked.message":
            "Sigue las instrucciones para permitir las alertas del BCV:",
        },
      },
      welcomeNotification: {
        disable: false,
    ...
    if (isLocalhost) {
      console.warn(
        "⚠️ OneSignal deshabilitado en local (Restricción de dominio)",
      );
    } else {
