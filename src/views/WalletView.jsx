...
export default function WalletView({ rates }) {
    ...
    const getColor = (type) => {
        switch (type) {
            ...
            case 'binance': return 'bg-amber-50 text-red-600 dark:bg-amber-900/20 dark:text-red-400';
            case 'transferencia': return 'bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300';
            default: return 'bg-amber-50 text-red-600 dark:bg-amber-900/20 dark:text-red-400';
        }
    };
