      ...
      <div className="grid grid-cols-2 gap-3 mb-5">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 border border-slate-100 dark:border-slate-800 shadow-sm relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-3 relative z-10">
            ...
            <div className="flex items-center gap-2 relative z-10">
              <span className="text-[10px] font-bold text-red-600 dark:text-red-400 bg-amber-50 dark:bg-amber-900/30 px-2 py-1 rounded-lg tracking-wider">
                HOY
              </span>
              <button
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 border border-slate-100 dark:border-slate-800 shadow-sm">
          ...
          <p className="text-[11px] text-slate-400 mt-1">
            <AnimatedCounter value={todayItemsSold} /> platos vendidos
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 border border-slate-100 dark:border-slate-800 shadow-sm relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-baseline gap-1">
              <span
                className={`text-2xl font-black tracking-tight ${todayProfit >= 0 ? "text-green-600 dark:text-green-400" : "text-red-500"}`}
              >
                {todayProfit >= 0 ? "+" : ""}$
