            ...
            <div className="w-full max-w-2xl bg-white rounded-[2rem] shadow-2xl overflow-hidden flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-500">
                ...
                >
                    ...
                    <ul className="text-sm text-slate-700 space-y-1 mb-4">
                        <li><strong>Gestión de menú</strong> con precios en múltiples monedas (USD, Bolívares)</li>
                        ...
                        <li><strong>Menú compartible</strong> mediante código temporal de 6 dígitos</li>
                    </ul>
                    ...
                    <ul className="text-sm text-slate-700 space-y-1 mb-2">
                        <li><strong>Gratuito:</strong> Dashboard básico, hasta 10 productos en el menú.</li>
                        <li><strong>Premium:</strong> Menú ilimitado, sistema de ventas POS, gestión de clientes, compartir menú, reportes completos.</li>
                    </ul>
                    <p className="text-sm text-slate-700 leading-relaxed mb-4">
