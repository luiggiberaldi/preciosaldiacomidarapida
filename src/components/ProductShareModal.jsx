            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <div className="flex gap-2">
                        ...
                        <button onClick={() => applyPreset('efectivo')} className="flex-1 py-2 px-3 bg-amber-50 dark:bg-amber-900/20 text-red-600 dark:text-red-400 rounded-xl text-xs font-bold border border-amber-100 dark:border-amber-800 hover:bg-amber-100 transition-colors">
                            💵 Efectivo
                        </button>
                    </div>
                </div>
