  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Icon */}
        <div
          className={`w-14 h-14 ${colors.iconBg} rounded-2xl flex items-center justify-center mx-auto mb-4`}
        >
          {icon}
        </div>

        {/* Title */}
        <h3 className="text-lg font-black text-slate-800 dark:text-white text-center mb-2">
          {title}
        </h3>

        {/* Message */}
        {message && (
          <p className="text-sm text-slate-500 dark:text-slate-400 text-center leading-relaxed mb-6 whitespace-pre-line">
            {message}
          </p>
        )}
