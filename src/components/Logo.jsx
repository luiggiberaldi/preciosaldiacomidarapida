...
export const LogoIcon = ({ className = "w-10 h-10" }) => {
  return (
    ...
    >
      ...
      */}
      <circle cx="48" cy="32" r="3" className="fill-brand animate-pulse" />
    </svg>
  );
};
...
export const LogoFull = ({ className = "" }) => {
  return (
    <div
      className={`flex items-center gap-3 group cursor-default ${className}`}
    >
      ...
      <div className="flex flex-col justify-center">
        ...
        <h1 className="text-xl font-black tracking-tighter leading-none text-slate-800 dark:text-white transition-colors duration-300">
          TasasAl
          <span className="text-brand inline-block group-hover:-translate-y-0.5 transition-transform duration-300">
            Día
          </span>
        </h1>
        {/* Subtítulo técnico */}
