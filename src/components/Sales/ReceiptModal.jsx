        ...
        <div className="flex-1 overflow-y-auto overscroll-contain">
          ...
          <div className="p-6 sm:p-8 pt-8 sm:pt-10 text-center bg-white border-b-2 border-dashed border-slate-200">
            ...
            <h3 className="text-4xl font-black text-slate-800 tracking-tighter mb-1">
              Orden #{String(receipt.saleNumber).padStart(2, "0")}
            </h3>
            <div
              className={`inline-block px-3 py-1 rounded-lg text-xs font-black uppercase tracking-widest mb-3 ${receipt.deliveryType === "LLEVAR" ? "bg-amber-100 text-amber-700" : "bg-blue-100 text-blue-700"}`}
            >
            ...
            {receipt.customerName && (
              <p className="text-sm font-bold text-slate-500 mb-2 uppercase tracking-tight">
                {receipt.customerName}
              </p>
            )}
          ...
          <div className="bg-slate-50 px-6 sm:px-8 py-6">
                ...
                {receipt.fiadoUsd > 0 && (
                  <div className="flex justify-between text-red-600 font-bold mt-2 pt-2 border-t border-slate-200">
                    ...
                    <span>
                      ...
                      {formatBs(receipt.fiadoUsd * receipt.rate)} Bs
                    </span>
                  </div>
                )}
              </div>
            ...
            <p className="text-center text-[10px] text-slate-400 mt-6 uppercase tracking-wider font-bold">
              Tasa BCV Aplicada: {formatBs(receipt.rate)} Bs/$
            </p>
            <p className="text-center text-[10px] text-slate-400 mt-1 uppercase tracking-wider font-bold">
